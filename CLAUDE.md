...
- **P2P-план, оставшийся шаг** (`P2P-PLAN.md`): 2.6 — финальный срез клиентской математики (`SnapshotInterpolator`/`TankPredictor`/`ShotPredictor`/`unpackFrame`) в ядро. Этап 5 закрыт целиком (5.2 — мягкая эстафета Worker'ов, см. секцию Browser host).
