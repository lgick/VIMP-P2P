...
| [core.md](core.md) | Rust-ядро симуляции (Этап 2 миграции): структура `core/`, ABI (команды/события/кадры), сборка WASM, тесты |
| [host.md](host.md) | Браузерный хост P2P (Этап 4 миграции): Worker с ядром, адаптер, loopback хоста-игрока, роутер главного потока |
