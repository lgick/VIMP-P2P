...
`src/master/main.js` — **точка входа проекта** (легаси авторитетный игровой сервер демонтирован на вехе демонтажа плана).
...
### GET /maps/manifest.json и GET /maps/:name (Этап 5.1)
