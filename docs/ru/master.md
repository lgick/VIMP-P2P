...
совместимость для всё ещё статической композиции движок↔игра
(`gameRegistry.static.js`); заменяется per-game маршрутами ниже, когда
клиент/хост перейдут на динамическую загрузку плагина (Этап 6.3/6.4).
